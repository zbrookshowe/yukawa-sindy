...
class Anisotropic_simulation(ys.Simulation):
    ...
    def simulate(self, duration, dt=0.001, x0=None):
        ...
        if x0 is None:
            ...
            self.x0 = x0
        x_clean = solve_ivp(self._EOM, t_span, self.x0, t_eval=t, **integrator_keywords).y.T
    ...
    def plot(self):
        ...
        r1, r1_dot, r2, r2_dot = self._generate_ptcl_coordinates(*self.x.T)
        # generate individual particle initial conditions
        r1_0, r1_0_dot, r2_0, r2_0_dot = self._generate_ptcl_coordinates(*self.x0)
